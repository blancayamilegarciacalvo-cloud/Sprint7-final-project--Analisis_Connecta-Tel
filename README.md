...
El análisis que se realizó fue de la empresa de telecomunicaciones en latinoamerica Connectel, con operaciones en México y Colombia, donde se trabajo con información registrada hasta el año 2024, lo cual permitio analizar el comportamiento del negocio dentro de ese periodo.
...
Para ello, se trabajo con tres fuentes de datos:
...
El flujo de trabajo que utilice para este proyecto fue el siguiente
...
3. El notebook carga automáticamente
